...
From now on when the computer boots up to the bcachefs-rollback menu you may either wait 15 seconds for the menu to timeout or just press the ENTER key to immidiately boot into /@root.
